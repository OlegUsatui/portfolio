const identity = {name: "Oleh Usatyi", image: "Profile-pic"};
const data = {
  NavBar: {...identity, links: ["Home", "About", "Portfolio", "Training", "Achievement", "Contact"]},
  Home: {
    introduction: "I am a Skilled Frontend Developer with 3+ years of experience in\n" +
      "Angular 2+, Typescript, HTML, CSS. Known for enhancing user\n" +
      "engagement by 40% through responsive and user-friendly web\n" +
      "designs",
    resumeLink: "1plLnPRjzXrrqQzrrrU8mqAU5suiGrSul",
    typedElement: ["Oleh Usatyi", "Frontend Developer",]
  },
  About: {
    ...identity,
    ...
    skills: [[{skill: "Spring Boot", progress: "90"}, {
      ...
      skill: "Kotlin",
      progress: "90"
    }, {skill: "Mongo DB", progress: "95"}, {skill: "MEAN/MERN Stack Development", progress: "85"}], [{
      skill: "JAVA",
      progress: "95"
    }, {skill: "C++", progress: "90"}, {skill: "Python", progress: "95"}, {
      skill: "HTML/CSS",
      progress: "90"
    }, {skill: "Javascript", progress: "90"}, {skill: "Git/GitHub", progress: "95"}, {
      skill: "DevOps",
      progress: "80"
    }]],
    education: [{
